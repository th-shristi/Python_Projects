# -*- coding: utf-8 -*-
"""MusicRecommendationSystem.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1laHVJRLrg3nub3O8X-gwWO3Y6SlCZqPy
"""
...
def get_trending_playlist_data(playlist_id, access_token):
    ...
    # Extracting relevant information and storing in a list of dictionaries
    music_data = []
...
playlist_id = '2WE9MMzipf5rxx0VqzrRaL' #Given in the link of Spotify playlist
...
def calculate_weighted_popularity(release_date):
    ...
    # Calculating the weighted popularity score based on time span (e.g., more recent releases have higher weight)
